...
DB_FLAVOR=${conf['ranger.db.flavor']}
#
...
db_root_user=${conf['ranger.jpa.jdbc.user']}
db_root_password=${conf['ranger.jpa.jdbc.password']}
db_host=${conf['ranger.db.host']}
#SSL config
...
#
db_name=${conf['ranger.jpa.jdbc.dbname']}
db_user=${conf['ranger.jpa.jdbc.user']}
db_password=${conf['ranger.jpa.jdbc.password']}
...
rangerAdmin_password=${conf['ranger.admin.password']}
rangerTagsync_password=${conf['ranger.admin.password']}
rangerUsersync_password=${conf['ranger.admin.password']}
keyadmin_password=${conf['ranger.admin.password']}


#Source for Audit Store. Currently solr, elasticsearch and cloudwatch logs are supported.
# * audit_store is solr
audit_store=${conf['audit.store']}
...
audit_solr_urls=${conf['audit.solr.urls']}
audit_solr_user=
audit_solr_password=
audit_solr_zookeepers=${conf['audit.solr.zookeepers']}

audit_solr_collection_name=${conf['audit.solr.collection.name']}
#solr Properties for cloud mode
audit_solr_config_name=${conf['audit.solr.config.name']}
audit_solr_configset_location=
audit_solr_no_shards=1
audit_solr_no_replica=1
audit_solr_max_shards_per_node=1
audit_solr_acl_user_list_sasl=${conf['audit.solr.acl.user.list.sasl']}
...
policymgr_external_url=${conf['ranger.external.url']}
